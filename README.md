...
- 📚 Currently diving deep into **Android, iOS, Cross-platform, and Web Development**. Eager to learn and contribute!
...
- 🌐 Check out my portfolio: [gursahibsingh.framer.ai](https://gursahibsingh.framer.ai/)
...
- **Lottery App** 🎟: Flutter-based lottery experience with dynamic ticket customization and barcode tech.
- **Dynamic Math Website** 📐: Simplifying complex math operations with a responsive and intuitive design.
- **Expense Tracker App** 💰: Flutter app for finance management with Google Sheets integration and visual insights.
- **Tic-Tac-Toe Game** 🎲: My first Flutter application, offering a fun-filled gaming experience.

📸 For screenshots and more details on these projects, check out [myProjects repo](https://github.com/Singh-Gursahib/myProjects).
